...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int opcao;
        do {
            System.out.println("\n=== RELATORIOS VIDA PLENA ===");
            System.out.println("1. Médico mais ocupado");
            System.out.println("2. Faltas por faixa de horário (clínica + eventos)");
            System.out.println("3. Evento com mais inscritos");
            System.out.println("4. Prato mais vendido (manhã) + contagem");
            ...
            System.out.println("11. Média dos pedidos no dia de cada evento");
            ...
            switch (opcao) {
                ...
                case 2 -> {
                    RelatoriosGerais.faltasPorFaixaDeHorario(listaConsultas, listaEventos);
                }
                case 3 -> {
                ...
                case 4 -> {
                    ...
                    if (p == null) {
                        ...
                        System.out.println("Prato mais vendido (manhã): " + p.getNome() + " | Quantidade pedida: " + cont);
                    }
                }
                case 5 -> relatorios.relatorioChoquesMedicoEvento();
                case 6 -> relatorios.relatorioPacientesFaltaramCompareceramEvento(listaConsultas, listaEventos);
                case 7 -> RelatoriosGerais.compararGastosCliente(listaConsultas, listaEventos);
                case 8 -> RelatoriosGerais.impactoRecomendacaoMedicaAuto(listaPedidos);
                case 9 -> relatorios.relatorioServicoMaisLucrativo(listaConsultas, listaPedidos, listaEventos);
                case 10 -> relatorios.relatorioFaixaHorarioMaisFrequente(listaConsultas, listaPedidos, listaEventos);
                case 11 -> RelatoriosGerais.mediaPedidosEventoTodos(listaEventos, listaPedidos);
                case 12 -> RelatoriosGerais.listarClientesEmMaisDeUmServico(listaConsultas, listaEventos);
                case 13 -> RelatoriosGerais.listarPercentuaisComparecimento(listaConsultas, listaEventos);
